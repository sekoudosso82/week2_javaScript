...
console.log("second element or item in oddArray: ", oddArray[1])
...
// oddArray[-1] = 9
// console.log("last element or item in oddArray: ", oddArray[-1])

oddArray[3] = 9
console.log("last element or item in oddArray: ", oddArray[3])
...
oddArray.push(13);
oddArray.push(15);
console.log("new oddArray: ", oddArray)
...
Print the result.*/
let stringFromOddArray = oddArray.join(",");
console.log("string From OddArray: ", stringFromOddArray)
