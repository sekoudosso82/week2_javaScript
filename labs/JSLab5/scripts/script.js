...
let number = 89673;
number%3 == 0 ? console.log("number % 3:",0):
...
console.log("subtract one and print the updated result: ", --result);

console.log("print out the value before subtracting 1: ", result--);
console.log("current result: ", result);
...
console.log("multiply string by number: ", result*3)
...
let numerator = -8 
let denominator = 0
denominator !== 0 ? console.log("division result: ", (numerator/denominator)): 
                    console.log("Divide by 0 ", (numerator/denominator));
